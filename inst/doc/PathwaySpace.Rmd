...
```{r Making a toy igraph - 2, eval=TRUE, message=FALSE, out.width="30%"}
...
```{r Setting vertex signal - 1, eval=TRUE, message=FALSE}
...
```{r Setting vertex signal - 2, eval=TRUE, message=FALSE}
...
```{r Circular projection - 1, eval=FALSE, message=FALSE, out.width="50%"}
...
# ggsave(filename = "./figures/fig2.png", height=3.5, width=4.7, 
#   units="in", device="png", dpi=300, plot=gg)
```

```{r fig2, echo=FALSE, out.width = '60%', purl=FALSE}
...
```{r Circular projection - 2, eval=FALSE, message=FALSE, out.width="50%"}
...
# gg <- plotPathwaySpace(pspace1, marks = c("n3","n4"))
# ggsave(filename = "./figures/fig3.png", height=3.5, width=4.7,
#   units="in", device="png", dpi=300, plot=gg)
```

```{r fig3, echo=FALSE, out.width = '60%', purl=FALSE}
...
```{r Circular projection - 3, eval=FALSE, message=FALSE, out.width="50%"}
...
```{r fig4, echo=FALSE, out.width = '55%', purl=FALSE}
...
```{r Polar projection - 1, eval=TRUE, message=FALSE, out.width="25%"}
...
```{r Polar projection - 3, eval=FALSE, message=FALSE, out.width="50%"}
...
```{r fig5, echo=FALSE, out.width = '55%', purl=FALSE}
...
```{r Polar projection - 4, eval=FALSE, message=FALSE, out.width="50%"}
...
```{r Signal types, eval=FALSE, message=FALSE, out.width="50%"}
...
# gg <- plotPathwaySpace(pspace1, marks = TRUE, mark.color = "magenta", 
#   bg.color = "white", font.color = "grey20", theme = "th2")
# ggsave(filename = "./figures/fig7.png", height=3.5, width=4.7,
#   units="in", device="png", dpi=300, plot=gg)
```

```{r fig7, echo=FALSE, out.width = '55%', purl=FALSE}
...
Next, we will load an *igraph* object with `n = 12990` vertices, containing gene interaction data available from the *Pathway Commons* database (version 12) [@Rodchenkov2019]. We will also load gene sets from the *MSigDB* collection [@Liberzon2015], which are subsequently used to project a binary signal
...
```{r PathwaySpace decoration - 2, eval=TRUE, message=FALSE, out.width="50%"}
...
We now mark the *HALLMARK_P53_PATHWAY* genes in the *PathwaySpace* object.
...
```{r fig8.png, eval=FALSE, message=FALSE, echo=FALSE, purl=FALSE}
gg <- plotPathwaySpace(pspace_PCv12, theme = "th2", 
  title="HALLMARK_P53_PATHWAY", marks = top10hubs, 
  mark.size = 2, font.size = 0.8)
ggsave(filename = "./figures/fig8.png", plot=gg, height=4,
...
Note that this image emphasizes groups of vertices forming *summits*, but it misses the outline of the graph structure, which faded due to the weakness of signal that reaches the furthermost points of the network.

## Mapping silhouettes

Next, we will decorate the *PathwaySpace* image with the graph's silhouettes.
...
```{r fig9.png, eval=FALSE, message=FALSE, echo=FALSE, purl=FALSE}
gg <- plotPathwaySpace(pspace_PCv12, theme = "th2", 
  title="HALLMARK_P53_PATHWAY", marks = top10hubs, 
  mark.size = 2, font.size = 0.8)
ggsave(filename = "./figures/fig9.png", plot=gg, height=4,
  width=5, units="in", device="png", dpi=300)
```
...
```{r fig10.png, eval=FALSE, message=FALSE, echo=FALSE, purl=FALSE}
gg <- plotPathwaySpace(pspace_PCv12, title="HALLMARK_P53_PATHWAY", 
  theme = "th2", font.size = 0.8,)
ggsave(filename = "./figures/fig10.png", plot=gg, height=4,
  width=5, units="in", device="png", dpi=300)
```

```{r fig10, echo=FALSE, out.width = '75%', purl=FALSE}
