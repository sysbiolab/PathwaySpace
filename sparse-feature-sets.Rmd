---
title: "Visualizing sparse feature sets"
subtitle: "Feature set projections on large graphs"
...
In order to enhance clarity and make it less likely for viewers to miss important details of large graphs, in this section we will create a *PathwaySpace* object with `n = 12990` vertices, upon which we will project binary signals representing feature sets from a relatively small number of vertices. The projection will emphasize clusters of vertices forming *summits*. We will add silhouette outlines as decorative elements to preserve the visibility of the overall graph structure. The examples in this section are adapted from @Ellrott2025 and @Tercan2025.
...
# ggsave(filename = "./figs_feature_sets/fig1.png", height=3.5, width=4.5,
#   units="in", device="png", dpi=300, plot=gg)
```

```{r fig1, echo=FALSE, out.width = '90%', purl=FALSE}
knitr::include_graphics("figs_feature_sets/fig1.png")
```
...
# 
# ggsave(filename = "./figs_feature_sets/fig2.png", plot=gg, height=4,
#   width=5, units="in", device="png", dpi=300)
# 
# ggsave(filename = "./figs_feature_sets/card1.png", plot=gg, height=4,
#   width=4, units="in", device="png", dpi=150)
```

```{r fig2, echo=FALSE, out.width = '100%', purl=FALSE}
knitr::include_graphics("figs_feature_sets/fig2.png")
```
...
# ggsave(filename = "./figs_feature_sets/fig3.png", plot=gg, height=4,
#   width=5, units="in", device="png", dpi=300)
```

```{r fig3, echo=FALSE, out.width = '100%', purl=FALSE}
knitr::include_graphics("figs_feature_sets/fig3.png")
```
