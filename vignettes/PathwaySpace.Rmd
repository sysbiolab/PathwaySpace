...
```{r Circular projection - 1, eval=TRUE, message=FALSE, out.width="50%"}
...
```{r Circular projection - 2, eval=TRUE, message=FALSE, out.width="50%"}
...
```{r Circular projection - 3, eval=TRUE, message=FALSE, out.width="50%"}
...
# Plot the PathwaySpace image
plotPathwaySpace(pspace1, marks = TRUE, theme = "th2")
```
...
```{r Signal types, eval=TRUE, message=FALSE, out.width="50%"}
...
```{r Polar projection - 3, eval=TRUE, message=FALSE, out.width="50%"}
...
```{r Polar projection - 4, eval=TRUE, message=FALSE, out.width="50%"}
