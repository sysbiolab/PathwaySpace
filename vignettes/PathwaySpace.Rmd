...
Next, we run signal projection using polar coordinates. The `beta` exponent will control the angular span; for values greater than zero, `beta` will progressively shift toward a polar projection.
...
```{r fig10, echo=FALSE, out.width = '80%', purl=FALSE}
...
```{r fig11, echo=FALSE, out.width = '90%', purl=FALSE}
...
```{r fig12, echo=FALSE, out.width = '90%', purl=FALSE}
...
```{r fig13, echo=FALSE, out.width = '90%', purl=FALSE}
