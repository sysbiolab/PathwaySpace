...
# Re-run the network signal projection with 'k = 2'
...
By default, a Weibull decay function is used for signal projection, passed to the `circularProjection()` function by the `decay.fun` argument. The user can pass additional arguments to the decay function, for example:
...
p_space1 <- circularProjection(p_space1, k = 2, pdist = 0.2, decay.fun = signalDecay(shape = 2))
...
p_space2 <- polarProjection(p_space2, k = 2, theta = 45, decay.fun = signalDecay(shape = 2))
...
p_space2 <- polarProjection(p_space2, k = 2, theta = 45, decay.fun = signalDecay(shape = 2), directional = TRUE)
...
p_space1 <- circularProjection(p_space1, k = 2, decay.fun = signalDecay(shape = 2))
