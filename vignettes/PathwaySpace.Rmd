...
```{r Making a toy igraph - 2, eval=TRUE, message=FALSE, out.width="40%"}
...
```{r Polar projection - 1, eval=TRUE, message=FALSE, out.width="40%"}
...
```{r Polar projection - 3, eval=FALSE, message=FALSE, out.width="70%"}
