...
```{r GraphSpace constructor - 2, eval=local_build, message=FALSE, fig.height=4.5, fig.width=4.5, out.width = '70%'}
...
# gg <- plotGraphSpace(gs1, node.labels = TRUE)
# ggsave(filename = "./vignettes/figures/fig2.png", height=4.5, width=4.5,
#   units="in", device="png", dpi=250, plot=gg)
```

```{r fig2, eval=TRUE, echo=FALSE, out.width = '70%', purl=FALSE}
...
```{r Circular projection - 1, eval=local_build, message=FALSE, fig.height=4.5, fig.width=5, out.width = '75%'}
...
# gg <- plotPathwaySpace(p_space1, marks = TRUE)
# ggsave(filename = "./vignettes/figures/fig3.png", height=4.5, width=5,
#   units="in", device="png", dpi=350, plot=gg)
```

```{r fig3, eval=TRUE, echo=FALSE, out.width = '75%', purl=FALSE}
...
```{r Circular projection - 3, eval=local_build, message=FALSE, fig.height=4.5, fig.width=5, out.width = '75%'}
...
```{r Polar projection - 2, eval=local_build, message=FALSE, fig.height=4.5, fig.width=4.5, out.width = '70%'}
# Check the graph layout
plotGraphSpace(gs2, node.labels = TRUE)
```

```{r fig5.png, eval=FALSE, message=FALSE, echo=FALSE, include=FALSE, purl=FALSE}
# gg <- plotGraphSpace(gs2, node.labels = TRUE)
# ggsave(filename = "./vignettes/figures/fig5.png", height=4.5, width=4.5,
#   units="in", device="png", dpi=250, plot=gg)
```

```{r fig5, eval=TRUE, echo=FALSE, out.width = '70%', purl=FALSE}
...
```{r Polar projection - 5, eval=local_build, message=FALSE, fig.height=4.5, fig.width=5, out.width = '75%'}
...
# gg <- plotPathwaySpace(p_space2, theme = "th2", marks = TRUE)
# ggsave(filename = "./vignettes/figures/fig6.png", height=4.5, width=5,
#   units="in", device="png", dpi=350, plot=gg)
```

```{r fig6, eval=TRUE, echo=FALSE, out.width = '75%', purl=FALSE}
...
```{r Polar projection - 6, eval=local_build, message=FALSE, fig.height=4.5, fig.width=5, out.width = '75%'}
...
# ggsave(filename = "./vignettes/figures/fig7.png", height=4.5, width=5,
#   units="in", device="png", dpi=350, plot=gg)
```

```{r fig7, eval=TRUE, echo=FALSE, out.width = '75%', purl=FALSE}
...
```{r Signal types - 2, eval=local_build, message=FALSE, fig.height=4.5, fig.width=4.5, out.width = '75%'}
...
#   marks = TRUE, mark.color = "magenta", theme = "th3")
# ggsave(filename = "./vignettes/figures/fig8.png", height=4.5, width=4.5,
#   units="in", device="png", dpi=350, plot=gg)
```

```{r fig8, eval=TRUE, echo=FALSE, out.width = '75%', purl=FALSE}
