...
```{r fig5, echo=FALSE, out.width = '70%', purl=FALSE}
...
[Visualizing feature sets in large *PathwaySpace* graphs](https://sysbiolab.github.io/PathwaySpace/visualizing-feature-sets.html){target="_blank" rel="noopener"}
