...
## Session information
    ...
    ## [1] PathwaySpace_1.2.4 RGraphSpace_1.2.4  ggplot2_4.0.3      igraph_2.3.1      
    ## 
    ...
    ## [49] rstudioapi_0.18.0  knitr_1.51         farver_2.1.2       patchwork_1.3.2   
    ## [53] htmltools_0.5.9    rmarkdown_2.31     compiler_4.6.0     S7_0.2.2
