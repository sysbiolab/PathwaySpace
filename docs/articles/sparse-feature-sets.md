...
# View the first few summit genes ("KLK5", "MMP2", "SERPINA1", ...)
head(summits[[1]])
#> [1] "KLK5"     "MMP2"     "SERPINA1" "SMN1"     "SMN2"     "PRKAA2"
```
...
## Session information
    ...
    #> [1] igraph_2.3.2       PathwaySpace_1.4.1 RGraphSpace_1.4.1  ggplot2_4.0.3     
    #> 
