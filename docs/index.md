...
[![CRAN
status](https://www.r-pkg.org/badges/version/PathwaySpace)](https://cran.r-project.org/package=PathwaySpace)
[![Lifecycle:
stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)](https://lifecycle.r-lib.org/articles/stages.html#stable)
[![CRAN
downloads](https://cranlogs.r-pkg.org/badges/PathwaySpace)](https://cranlogs.r-pkg.org/badges/PathwaySpace)
[![License:
...
![fig1.png](articles/figs_intro/fig1.png)
...
> used in the *quick start* section of this vignette. **B**)
> Illustration of signal projection from two neighboring vertices,
> simplified to one dimension. **Right**: Signal profiles from
> aggregation and decay functions.”

The projection model considers the vertex-signal positions as source
